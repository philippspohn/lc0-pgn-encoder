...
constexpr int LC0_VERSION_MAJOR = 0;
constexpr int LC0_VERSION_MINOR = 0;
constexpr int LC0_VERSION_PATCH = 1;
const std::string LC0_VERSION_POSTFIX = "encoder-only";
const std::string BUILD_IDENTIFIER = "encoder-only-build";
